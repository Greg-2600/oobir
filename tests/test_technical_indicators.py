...
class TestTechnicalIndicators(unittest.TestCase):
    ...
    def test_calculate_technical_indicators_contains_expected_sections(self):
        ...
        text = flow._calculate_technical_indicators(
            df
    ...
    def test_ai_technical_analysis_includes_indicators(
        self, mock_price, mock_ensure, mock_chat
    ):
        ...
        self.assertRegex(
            user_msg["content"], r"20-day SMA|RSI \(14\)|MACD|Bollinger Bands"
        )
